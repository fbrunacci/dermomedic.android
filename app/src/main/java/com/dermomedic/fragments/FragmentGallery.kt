...
import com.dermomedic.BuildConfig
import com.dermomedic.R
import com.dermomedic.database.AnalyseDatabase
import com.dermomedic.databinding.FragmentGalleryBinding
import com.dermomedic.utils.padWithDisplayCutout
import com.dermomedic.utils.showImmersive
import java.io.File
import java.util.*
...
class GalleryFragment internal constructor() : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mediaList.getOrNull(mediaViewPager.currentItem)?.let { mediaFile ->
            viewModel.updateCurrentAnalyse(mediaFile.name)
        }
        mediaViewPager.addOnPageChangeListener(object :ViewPager.SimpleOnPageChangeListener() {
            override fun onPageScrollStateChanged(state: Int) {
                when( state ) {
                    ViewPager.SCROLL_STATE_DRAGGING -> viewModel.clearAnalyse()
        ...
        view.findViewById<ImageButton>(R.id.analyse_button).setOnClickListener {
            mediaList.getOrNull(mediaViewPager.currentItem)?.let { mediaFile ->
                viewModel.onAnalyse(mediaFile)
            }
        }
